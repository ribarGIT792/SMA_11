% Niutono-Koteso formules: tyrimas cikle
...
n=9;  % orientacinis integravimo tasku skaicius
n=floor((n-1)/(N-1))*(N-1)+1
...
format long
Integralas(iii-1)=Newton_Cotes(F,a,b,N)
...
legend({'tiksli integralo reiksme','skaitiskai apskaiciuotos reiksmes skirtingomis N-K formulemis' })
